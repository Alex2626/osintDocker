...
function getReportsUsersURJC(){
	...
	do		
		...
		echo $edate
		saveReport
		#-u eldiarioes -t 200 -i --sdate 25-06-2018 --edate 02-07-2018 --hashtags --mentions --find [+]urjc -o 
	done
...
function sendInform(){
	python /root/Tools/PythonScripts/sendMailZipOutlook.py -i /root/Tools/tinfoleak-2.1-SHA2017_Edition/Output_Reports/Tinfoleak-${edate}.zip
